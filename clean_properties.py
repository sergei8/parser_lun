...
# @Author  : Shkliarskiy 
# 
# программа выбирает из lun-файла все показатели с
...
# publish_date      - дата публикации объявления
...
OUTPUT_FILE = 'aprt_properties.csv'
INPUT_FILE ='aprts_data_ukr.csv'
    ...
    with open(INPUT_FILE) as input_file, \
        ...
        for line in input_file:
            ...
            try:
                ...
                total_area, living_area, kitchen_area = (None, None, None)
